<template lang="pug">
  .page
    ...
    crud(name="商品一级分类" :form='form'  ref='form'  hasIndex  hasAdd hideSelect v-show="activeName=='first'" :btns-shown="btns")
    crud(name="商品二级分类" :form='form2'  ref='form2'  hasIndex  hasAdd  v-show="activeName=='second'" :model-src="modelSrc" :btns-shown="btns")
      el-form(:inline="true")
